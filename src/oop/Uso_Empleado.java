...
public class Uso_Empleado {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println(jefa_Finanzas.tomar_decisiones("Dar mas dÃ­as de vacaciones"
				+ " a los empleados"));
		...
		System.out.println("InformaciÃ³n los empleados...");
...
class Jefatura extends Empleado implements Jefes{
	...
	public String tomar_decisiones(String decision) {
		...
		return "La decisiÃ³n tomada por el jefe es: " + decision;
